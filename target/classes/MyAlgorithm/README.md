...
[Selenium](https://www.selenium.dev/documentation/en/) and focuses on using it with Percy. You'll still
be able to follow along if you're not familiar with Java Selenium, but we won't
spend time introducing Java Selenium concepts. It requires Java 8 and Maven >3.6.
